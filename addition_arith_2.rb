...
class NumberFlashcard
  ...
  def initialize number1, number2, number3
    ...
    @num_2 = number2
    @num_3 = number3
    @solution = number1.number + number2.number + number3.number
  end
  ...
  def to_s
    "#{@num_1.number} + #{@num_2.number} + #{@num_3.number}"
  end
end
...
10.times do
  ...
  num_3 = RandomNumber.new
  flashcard = NumberFlashcard.new num_1, num_2, num_3
